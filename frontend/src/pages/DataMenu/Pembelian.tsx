...
export default function Pembelian() {
  ...
  useEffect(() => {
    ...
    setFilteredData(
      data.filter((i) =>
        [i.nama_item, i.kode_item, i.jenis, i.satuan]
  ...
  return (
    <>
      <PageMeta title="Data Pembelian" description="Laporan pembelian per periode (Big Data Mode)" />
      ...
      <ComponentCard title="Filter Periode Pembelian">
